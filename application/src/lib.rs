...
pub use persist::{
    BackerUpper, BackupResult, MemIndex, PersistError, PersistLocation, ScrapePersistResult,
    ScrapePersistResultSummarizer, ScrapePersistResultSummary, Shard, Storage, StorageFetch,
